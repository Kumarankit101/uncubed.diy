    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: repoName,
          message: !repoExists ? 'Initial commit from Uncubed.diy' : 'Update from Uncubed.diy',
          tree: treeData.sha,
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-uncubed-elements-background-depth-1 rounded-lg border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark">
                          Successfully pushed to GitHub
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-uncubed-elements-textTertiary hover:text-uncubed-elements-textPrimary dark:text-uncubed-elements-textTertiary-dark dark:hover:text-uncubed-elements-textPrimary-dark hover:bg-uncubed-elements-background-depth-2 dark:hover:bg-uncubed-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-uncubed-elements-borderColor dark:focus:ring-uncubed-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 rounded-lg p-4 text-left border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                    ...
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-uncubed-elements-background-depth-1 dark:bg-uncubed-elements-background-depth-4 px-3 py-2 rounded border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-uncubed-elements-textSecondary hover:text-uncubed-elements-textPrimary dark:text-uncubed-elements-textSecondary-dark dark:hover:text-uncubed-elements-textPrimary-dark bg-uncubed-elements-background-depth-1 dark:bg-uncubed-elements-background-depth-4 rounded-lg border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark"
                  ...
                  <div className="bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 rounded-lg p-4 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark border-b border-uncubed-elements-borderColor/30 dark:border-uncubed-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-uncubed-elements-background-depth-3 dark:bg-uncubed-elements-background-depth-4 text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark ml-2">
                            {(file.size / 1024).toFixed(1)} KB
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark hover:bg-uncubed-elements-background-depth-3 dark:hover:bg-uncubed-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark hover:bg-uncubed-elements-background-depth-3 dark:hover:bg-uncubed-elements-background-depth-4 text-sm border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-uncubed-elements-background-depth-1 rounded-lg p-6 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark shadow-xl"
              ...
              >
                <div className="relative text-center space-y-4">
                  ...
                  <p
                    ...
                    className="text-sm text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitHub, you need to connect your GitHub account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark text-sm hover:bg-uncubed-elements-background-depth-3 dark:hover:bg-uncubed-elements-background-depth-4 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
            ...
            >
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <Dialog.Title className="text-lg font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark">
                      Deploy to GitHub
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 rounded-lg border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                  ...
                  <div>
                    <p className="text-sm font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-uncubed-elements-textTertiary dark:text-uncubed-elements-textTertiary-dark">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-uncubed-elements-textTertiary dark:text-uncubed-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            ...
                            >
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-uncubed-elements-background-depth-2 dark:bg-uncubed-elements-background-depth-3 rounded-lg border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                      ...
                      <label
                        htmlFor="private"
                        className="text-sm text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-uncubed-elements-textTertiary dark:text-uncubed-elements-textTertiary-dark mt-2 ml-6">
