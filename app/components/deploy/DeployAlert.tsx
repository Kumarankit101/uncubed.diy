          ...
          >
            <div
              className={classNames(
                'text-xl',
                type === 'success'
                  ? 'i-ph:check-circle-duotone text-uncubed-elements-icon-success'
                  : type === 'error'
                    ? 'i-ph:warning-duotone text-uncubed-elements-button-danger-text'
                    : 'i-ph:info-duotone text-uncubed-elements-loader-progress',
              )}
            ></div>
          </motion.div>
          {/* Content */}
                    ...
                    <div className="flex items-center">
                      <div
                        className={classNames(
                          ...
                          buildStatus === 'running'
                            ? 'bg-uncubed-elements-loader-progress'
                            : buildStatus === 'complete'
                              ? 'bg-uncubed-elements-icon-success'
                              : buildStatus === 'failed'
                                ? 'bg-uncubed-elements-button-danger-background'
                                : 'bg-uncubed-elements-textTertiary',
                        )}
                      >
                        {buildStatus === 'running' ? (
              ...
              {url && type === 'success' && (
                <div className="mt-2">
                  <a
                    ...
                    className="text-uncubed-elements-item-contentAccent hover:underline flex items-center"
                  >
