...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--uncubed-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--uncubed-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--uncubed-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  const GripIcon = () => (
    ...
    >
      <div
        style={{
          color: 'var(--uncubed-elements-textSecondary, rgba(0,0,0,0.5))',
          fontSize: '10px',
          lineHeight: '5px',
          userSelect: 'none',
          marginLeft: '1px',
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-uncubed-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-uncubed-elements-background-depth-3' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-uncubed-elements-preview-addressBar-background border border-uncubed-elements-borderColor text-uncubed-elements-preview-addressBar-text rounded-full px-1 py-1 text-sm hover:bg-uncubed-elements-preview-addressBar-backgroundHover hover:focus-within:bg-uncubed-elements-preview-addressBar-backgroundActive focus-within:bg-uncubed-elements-preview-addressBar-backgroundActive focus-within-border-uncubed-elements-borderColorActive focus-within:text-uncubed-elements-preview-addressBar-textActive">
          <PortDropdown
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton
            ...
            className={
              isInspectorMode ? 'bg-uncubed-elements-background-depth-3 !text-uncubed-elements-item-contentAccent' : ''
            }
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-uncubed-elements-textTertiary hover:text-uncubed-elements-textPrimary`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-uncubed-elements-textTertiary">Show Device Frame</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            showDeviceFrame ? 'bg-[#EA580C]' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-uncubed-elements-textTertiary">Landscape Mode</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            isLandscape ? 'bg-[#EA580C]' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-[#111827] dark:text-gray-300 text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-[#FFF7ED] dark:hover:bg-gray-900 bg-white dark:bg-black"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-[#6B7280] dark:text-gray-400 group-hover:text-[#EA580C] dark:group-hover:text-[#EA580C] transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        <span className="font-medium group-hover:text-[#EA580C] dark:group-hover:text-[#EA580C] transition-colors duration-200">
                          {size.name}
                        </span>
                        <span className="text-xs text-[#6B7280] dark:text-gray-400 group-hover:text-[#EA580C] dark:group-hover:text-[#EA580C] transition-colors duration-200">
                      ...
                      {selectedWindowSize.name === size.name && (
                        <div className="text-[#EA580C] dark:text-[#EA580C]">
                          <svg
      ...
      <div className="flex-1 border-t border-uncubed-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--uncubed-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-uncubed-elements-background-depth-1"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex w-full h-full justify-center items-center bg-uncubed-elements-background-depth-1 text-uncubed-elements-textPrimary">
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--uncubed-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--uncubed-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
