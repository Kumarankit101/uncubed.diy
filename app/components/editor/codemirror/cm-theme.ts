...
function getEditorTheme(settings: EditorSettings) {
  return EditorView.theme({
    ...
    '.cm-tooltip.cm-readonly-tooltip': {
      padding: '4px',
      whiteSpace: 'nowrap',
      backgroundColor: 'var(--uncubed-elements-bg-depth-2)',
      borderColor: 'var(--uncubed-elements-borderColorActive)',
      '& .cm-tooltip-arrow:before': {
        borderTopColor: 'var(--uncubed-elements-borderColorActive)',
      },
