      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-uncubed-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-uncubed-elements-item-backgroundAccent hover:bg-uncubed-elements-artifacts-backgroundHover"
