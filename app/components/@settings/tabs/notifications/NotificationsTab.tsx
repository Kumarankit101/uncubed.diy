...
const NotificationsTab = () => {
  ...
  const filterOptions: { id: FilterType; label: string; icon: string; color: string }[] = [
    { id: 'all', label: 'All Notifications', icon: 'i-ph:bell', color: '#f97316' },
    { id: 'system', label: 'System', icon: 'i-ph:gear', color: '#6b7280' },
    { id: 'update', label: 'Updates', icon: 'i-ph:arrow-circle-up', color: '#f97316' },
    ...
    { id: 'network', label: 'Network', icon: 'i-ph:wifi-high', color: '#F97316' },
  ];
