              ...
              {activeTab === 'url' ? (
                  ...
                  <div className="bg-gradient-to-br from-uncubed-elements-background-depth-1 to-uncubed-elements-background-depth-1 dark:from-uncubed-elements-background-depth-2-dark dark:to-uncubed-elements-background-depth-2-dark p-5 rounded-xl border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="w-full pl-10 py-3 border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                    </div>
                ...
                <>
                  ...
                  <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    {selectedRepository ? (
                      <div className="space-y-5 bg-gradient-to-br from-purple-500/5 to-blue-500/5 p-5 rounded-xl border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark">
                        ...
                        <div className="pt-3 border-t border-uncubed-elements-borderColor/30 dark:border-uncubed-elements-borderColor-dark/30">
                          ...
                          <select
                            ...
                            className="w-full px-3 py-3 rounded-lg bg-white dark:bg-uncubed-elements-background-depth-4 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor-dark text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
                          >
                            {branches.map((branch) => (
                              <option
                                key={branch.name}
