...
export default function NetlifyConnection() {
          ...
          <CollapsibleTrigger asChild>
            <div className="flex items-center justify-between p-4 rounded-lg bg-uncubed-elements-background dark:bg-uncubed-elements-background-depth-2 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor hover:border-uncubed-elements-borderColorActive/70 dark:hover:border-uncubed-elements-borderColorActive/70 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar w-4 h-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                <span className="text-sm font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary">
                  Netlify Stats
                </span>
              </div>
              <div
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="space-y-4 mt-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge
                  variant="outline"
                  className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                >
                  <BuildingLibraryIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent" />
                ...
                <Badge
                  ...
                  className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                >
                  <RocketLaunchIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent" />
                ...
                {lastUpdated && (
                  <Badge
                    ...
                    className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                  >
                    <ClockIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-uncubed-elements-background dark:bg-uncubed-elements-background-depth-1 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="text-sm font-medium flex items-center gap-2 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary">
                        <BuildingLibraryIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="flex items-center gap-2 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary hover:bg-uncubed-elements-item-backgroundActive/10"
                      >
                        <ArrowPathIcon
                          className={classNames(
                            'h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={classNames(
                            'bg-uncubed-elements-background dark:bg-uncubed-elements-background-depth-1 border rounded-lg p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-uncubed-elements-item-contentAccent bg-uncubed-elements-item-backgroundActive/10'
                              : 'border-uncubed-elements-borderColor hover:border-uncubed-elements-borderColorActive/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="h-5 w-5 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                              <span className="font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary">
                                {site.name}
                              </span>
                            </div>
                            <div className="flex items-center gap-2">
                              ...
                              >
                                ...
                                <span className="text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary">
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-sm flex items-center gap-1 transition-colors text-uncubed-elements-link-text hover:text-uncubed-elements-link-textHover dark:text-white dark:hover:text-uncubed-elements-link-textHover"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="h-3 w-3 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="mt-4 pt-3 border-t border-uncubed-elements-borderColor">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                                    >
                                      <action.icon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                    <span className="text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="flex items-center gap-1 mt-1">
                                      <CodeBracketIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                      <span className="text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary">
                    ...
                    <div className="bg-uncubed-elements-background dark:bg-uncubed-elements-background-depth-1 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor rounded-lg p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-uncubed-elements-background dark:bg-uncubed-elements-background-depth-1 border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor rounded-lg p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                              ...
                              <span className="text-xs text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="mt-2 text-xs text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary flex items-center gap-1">
                                <CodeBracketIcon className="h-3 w-3 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                <span className="text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 transition-colors text-uncubed-elements-link-text hover:text-uncubed-elements-link-textHover dark:text-white dark:hover:text-uncubed-elements-link-textHover"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="h-3 w-3 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                            ...
                            <div className="flex items-center gap-2 mt-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                                >
                                  <LockClosedIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary"
                                >
                                  <LockOpenIcon className="h-4 w-4 text-uncubed-elements-item-contentAccent dark:text-uncubed-elements-item-contentAccent" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                      ...
                      <div className="space-y-2">
                        {builds.map((build) => (
                          ...
                          >
                            ...
                            {build.error && (
                              <div className="mt-2 text-xs text-uncubed-elements-textDestructive dark:text-uncubed-elements-textDestructive flex items-center gap-1">
                                <XCircleIcon className="h-3 w-3 text-uncubed-elements-textDestructive dark:text-uncubed-elements-textDestructive" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="space-y-6 bg-uncubed-elements-background dark:bg-uncubed-elements-background border border-uncubed-elements-borderColor dark:border-uncubed-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-uncubed-elements-textPrimary">Netlify Connection</h2>
          </div>
        </div>
