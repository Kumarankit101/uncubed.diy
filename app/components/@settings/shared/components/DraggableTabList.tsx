    ...
    >
      <div className="flex items-center gap-4">
        <div className="cursor-grab">
          <div className="i-ph:dots-six-vertical w-4 h-4 text-uncubed-elements-textSecondary" />
        </div>
        <div>
          <div className="font-medium text-uncubed-elements-textPrimary">{TAB_LABELS[tab.id]}</div>
          {showControls && (
            <div className="text-xs text-uncubed-elements-textSecondary">
      ...
      {showControls && !tab.locked && (
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            />
            <label className="text-sm text-uncubed-elements-textSecondary">Visible</label>
          </div>
          <div className="flex items-center gap-2">
            <label className="text-sm text-uncubed-elements-textSecondary">User</label>
            <Switch
            ...
            />
            <label className="text-sm text-uncubed-elements-textSecondary">Dev</label>
          </div>
        </div>
      )}
    </motion.div>
