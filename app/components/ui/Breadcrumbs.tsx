      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-uncubed-elements-textPrimary dark:text-uncubed-elements-textPrimary-dark'
              : 'text-uncubed-elements-textSecondary dark:text-uncubed-elements-textSecondary-dark hover:text-uncubed-elements-textPrimary dark:hover:text-uncubed-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-uncubed-elements-textTertiary dark:text-uncubed-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
