  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-uncubed-elements-borderColor bg-uncubed-elements-background-depth-1 text-uncubed-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-uncubed-elements-textSecondary', className)} {...props} />;
  },
);
