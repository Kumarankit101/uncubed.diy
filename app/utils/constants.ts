...
export const MODIFICATIONS_TAG_NAME = 'uncubed_file_modifications';
export const MODEL_REGEX = /^\[Model: (.*?)\]\n\n/;
export const PROVIDER_REGEX = /\[Provider: (.*?)\]\n\n/;
export const DEFAULT_MODEL = import.meta.env.VITE_DEFAULT_LLM_MODEL || 'claude-3-5-sonnet-latest';
...
export const DEFAULT_PROVIDER =
  PROVIDER_LIST.find((p) => p.name === import.meta.env.VITE_DEFAULT_LLM_PROVIDER) || llmManager.getDefaultProvider();
