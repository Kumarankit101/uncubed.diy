...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('uncubed_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('uncubed_profile', JSON.stringify(profileStore.get()));
  }
};
