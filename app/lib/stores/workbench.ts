...
export class WorkbenchStore {
  ...
  get uncubedTerminal() {
    return this.#terminalStore.uncubedTerminal;
  }
  get alert() {
  ...
  attachUncubedTerminal(terminal: ITerminal) {
    this.#terminalStore.attachUncubedTerminal(terminal);
  }
