...
<artifact_info>
  ...
  - Use \`<uncubedArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<uncubedAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<uncubedArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<uncubedAction>\` tags with appropriate \`type\` attribute:
