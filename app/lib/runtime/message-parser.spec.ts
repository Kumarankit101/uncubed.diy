...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out uncubed artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <uncubed', 'Foo bar '],
      ['Foo bar <uncubeda', 'Foo bar <uncubeda'],
      ['Foo bar <uncubedA', 'Foo bar '],
      ['Foo bar <uncubedArtifacs></uncubedArtifact>', 'Foo bar <uncubedArtifacs></uncubedArtifact>'],
      ['Before <oltArtfiact>foo</uncubedArtifact> After', 'Before <oltArtfiact>foo</uncubedArtifact> After'],
      ['Before <uncubedArtifactt>foo</uncubedArtifact> After', 'Before <uncubedArtifactt>foo</uncubedArtifact> After'],
    ])('should correctly parse chunks and strip out uncubed artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <uncubedArtifact title="Some title" id="artifact_1">foo bar</uncubedArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <uncubedArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</uncubedArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</uncubedArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</uncubedArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/uncubedArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <uncubedArtifact title="Some title" id="artifact_1">foo</uncubedArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <uncubedArtifact title="Some title" id="artifact_1"><uncubedAction type="shell">npm install</uncubedAction></uncubedArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <uncubedArtifact title="Some title" id="artifact_1"><uncubedAction type="shell">npm install</uncubedAction><uncubedAction type="file" filePath="index.js">some content</uncubedAction></uncubedArtifact> After',
        {
          output: 'Before  After',
